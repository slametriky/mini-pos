                            ...
                            <form method="POST" id="formTampil">
                                <div class="form-group">
                                    <div class="col-sm-12 col-md-6">
                                        <select id="selectKegiatan" name="kegiatan" class="form-control" required>
                                            <option value="">Pilih Kegiatan</option>                                                
                                            @foreach ($kegiatans as $kegiatan)
                                                <option value="{{ $kegiatan->id }}">{{ $kegiatan->kode_kegiatan }}-{{ $kegiatan->desk_kegiatan }}</option>                                                
                                            @endforeach                                    
                                        </select>
                                    </div>
                                </div>        
            ...
            <form id="formTambah" method="post">                
                <div class="modal-body">     
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-12 col-md-2 col-lg-2">Kegiatan</label>
                        <div class="col-sm-12 col-md-9">
                            <input type="text" class="form-control" id="kro" name="kro" placeholder="Kro" autocomplete="off" required>
                        </div>
                    </div>                                                             
                </div>
          ...
          <div class="modal-content">
            ...
            <form id="formEdit" method="post">                
                <div class="modal-body">     
                    ...
                    <input type="hidden" name="kegiatan" id="kegiatanEdit">     
                    <div class="form-group row">
                        <label class="col-form-label col-12 col-md-2 col-lg-2">Kode</label>
                        <div class="col-sm-12 col-md-2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-9">
                            <input type="text" class="form-control" id="kro_e" name="kro" placeholder="KRO" autocomplete="off" required>
                        </div>
                    </div>                                                             
                </div>
                <div class="modal-footer bg-whitesmoke br">
...
@push('page-script')
    <script>
        ...
        editData = (id) => {
            ...
            $("#kegiatanEdit").val(tmpId);           
            $("#kode_e").val(curData[0].kode_kro);                
            $("#kro_e").val(curData[0].desk_kro);                
        ...
        loadKegiatan = () => {
            axios.post('/admin/data_kegiatan', {                                
            })
            .then((res) => {                            
        ...
        document.addEventListener('DOMContentLoaded', function() {            
            ...
            formTampil.onsubmit = (e) => {
                ...
                let kegiatan = $("#selectKegiatan").val();  
